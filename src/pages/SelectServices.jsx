...
function SelectServices() {
  ...
  const fetchServices = async () => {
    try {
      ...
      setServices([
        { id: '1', name: 'ميكب خفيف', nameAr: 'ميكب خفيف', price: 50 },
        { id: '2', name: 'سشوار للشعر', nameAr: 'سشوار للشعر', price: 50 },
        { id: '3', name: 'مانيكير', nameAr: 'مانيكير', price: 50 },
        { id: '4', name: 'باديكير', nameAr: 'باديكير', price: 50 },
        { id: '5', name: 'فورمة للشعر', nameAr: 'فورمة للشعر', price: 50 },
      ])
    } finally {
      setLoading(false)
    }
  ...
  return (
    <div className="bg-white min-h-screen max-w-[390px] mx-auto relative">
      ...
      <div className="fixed top-[66px] left-1/2 transform -translate-x-1/2 w-full max-w-[390px] flex items-center justify-between px-5 bg-white z-10">
        ...
        <h1 className="text-lg font-bold text-gray-800">حدد الخدمات</h1>
